...
async function viewAdmin(tab){
  ...
  try {
    ...
    app.innerHTML = topbar('Betreiber-Cockpit','barber', `<span class="pill" onclick="AF.logout()" style="cursor:pointer">Abmelden</span>`) + `<div class="view"><div class="tabs">${tabs}</div>${body}<div style="height:20px"></div></div>`;
