...
async function handleAuthRedirect(){
  ...
  // Supabase kann Token als Fragment liefern: #access_token=...&type=recovery
  // oder als Query nach einem Redirect: ?access_token=...
  ...
  try {
    ...
    // Session erfolgreich gesetzt
    await loadSession();
  } catch(e){ authError = 'Login-Fehler: ' + errMsg(e); return true; }
  // Bei Passwort-Reset: direkt zur Passwort-Seite
  if (type === 'recovery'){
