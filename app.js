...
async function viewShop(id){
  ...
  try {
    ...
    app.innerHTML = topbar('', 'home') + `<div class="view">
      ${s.portfolio_image ? `<div class="profile-hero"><img src="${esc(s.portfolio_image)}" onerror="this.parentElement.style.display='none'"></div>` : miniHero()}
