...
function dashMore(navHtml){
  ...
  app.innerHTML = topbar('Mehr') + `<div class="view">
    ...
    ${(s.staff||[]).length > 0 ? `<div class="card click" onclick="location.hash='#/team'"><div class="name">👥 Team verwalten</div><div class="meta">Mitarbeiter einladen und Rechte vergeben</div></div>` : ''}
    ${stripeCard}
